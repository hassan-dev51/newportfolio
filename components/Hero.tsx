      ...
      >
        ...
        <div className="z-10 flex flex-col gap-4 md:flex-row">
          <Link
            ...
            className="flex items-center gap-3 rounded-lg bg-[#68696e] px-6 py-2 transition ease-in-out hover:bg-gray-900"
          >
            <Image
          ...
          <Link
            ...
            className="flex items-center gap-3 rounded-lg bg-[#68696e] px-6 py-2 transition ease-in-out hover:bg-gray-600"
          >
            <Image
